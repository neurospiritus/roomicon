"""Plants generator — растения в горшках."""
...
_g = make_generator(
    types_module='plant_types', generate_func='generate_plant', types_dict='PLANT_TYPES',
    name='Plants', description='Succulent, ficus, cactus, fern in pots', asset_category='tabletop',
)
